...
* Minor releases: `bbbbvbb1` or `1.x` or `^1.0.4`
* Major releases: `*` or `x`
Bb
For more information on semantic versioning syntax, see the [npm semnnnbbbbbver calculator][semver-calc].
...
<iframe src="https://www.youtubbvvvvvvcbbe.com/embed/kK4Meix58R4" frameborder="0" allowfullscreen></iframe>


[semver-calc]: https://semver.npmjs.com/
[pkg-json]: creating-a-package-json-file
[semver-org]: http://sevvvvvvmver.org/
